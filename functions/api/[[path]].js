 ...
 *
 * تعمل تلقائيًا على https://taybaa-library.pages.dev/api/...
 * لا تحتاج VPS أو SSH أو تشغيل يدوي.
 * Cloudflare يعيد البناء تلقائيّاً عند أي push.
 */
...
const JOURNEYS = [
    {
        ...
        description: 'رحلة في تراث الأدب الخالد',
        icon: '📜',
        difficulty: 'متوسّط',
        durationWeeks: 8,
        keywords: ['ديوان', 'أبو الطيّب', 'الجاحظ']
    },
    {
        ...
        difficulty: 'مبتدئ',
        durationWeeks: 6,
        keywords: ['العقيدة', 'علوم القرآن', 'رياض الصالحين']
    },
    {
        ...
        difficulty: 'مبتدئ',
        durationWeeks: 4,
        keywords: ['ريادة', 'مشروع', 'التسويق']
    },
    {
        id: 'arab-mind-20c',
        title: 'العقل العربي في القرن العشرين',
        description: 'فلاسفة ومفكّرون',
        icon: '🧠',
        difficulty: 'متقدّم',
        durationWeeks: 12,
        keywords: ['طه حسين', 'جبران', 'الجابري']
    }
];

// In-memory cache (per Worker instance, ~5 min lifetime)
let booksCache = null;
